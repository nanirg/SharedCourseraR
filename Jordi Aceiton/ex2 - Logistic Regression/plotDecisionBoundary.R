...
plotDecisionBoundary <- function (theta, X, y, 
                                  axLables = NULL, legLabels = NULL)   {        
## =============================================================================        
##   plotDecisionBoundary(theta, X, y) Plots the data points X and y into a new
##                                      figure with the decision boundary 
##                                      defined by theta.
##        
...
##
##   output:    a plot with decision boundary.
##                     
## =============================================================================    
